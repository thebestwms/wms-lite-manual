...
const MDM_TRANSLATIONS = {
  ja: {
    ...
    "同一套 Item 主档适配不同行业资料": "1 つの Item マスタで異なる業種情報に対応する", "行业主档": "業種マスタ", "字段模板": "項目テンプレート", "商品填写": "商品入力", "确定商品所属行业": "商品の業種を決定", "按所选行业动态显示并保存属性": "選択した業種に応じて属性を表示・保存", "其他仓储流程": "その他の倉庫フロー",
