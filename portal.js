...
const translations = {
  zh: {
    ...
    openMenu: "打开菜单", closeMenu: "关闭菜单", expand: "展开", collapse: "收起"
  },
  ja: {
    ...
    openMenu: "メニューを開く", closeMenu: "メニューを閉じる", expand: "展開", collapse: "折りたたむ"
  },
  en: {
    ...
    openMenu: "Open menu", closeMenu: "Close menu", expand: "Expand", collapse: "Collapse"
  }
};
...
function selectRoute(link, pushHistory = true) {
  ...
  frame.src = frameUrl(page, section);
  updateCurrentTitle();
